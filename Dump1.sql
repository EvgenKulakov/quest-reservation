...
--
-- Host: 127.0.0.1    Database: quest_reservations
-- ------------------------------------------------------
...
INSERT INTO `admins` VALUES (1,'test','test@test.com','+79995200000','test',1000000);
...
INSERT INTO `clients` VALUES (34,1,'Slava Boroda','Sugar','+79992223344','kkk@mail.ru',NULL),(35,1,'Familyan','Igor','+79006665544','kkk@mail.ru',NULL),(36,1,'Слава','Курильский','+79006665544','kkk@mail.ru',NULL),(37,1,'Familyan','Igor','+79006665544','',NULL),(38,1,'Familyan','Igor','+79006665544','kkk@mail.ru',NULL),(39,1,'Familyan','Igor','+79006665544','kkk@mail.ru',NULL);
...
INSERT INTO `reservations` VALUES (12,'2023-08-03','15:00:00',NULL,NULL,NULL,NULL,15,7,'default',NULL,34,3,'',NULL,'default'),(16,'2023-08-03','16:30:00',NULL,NULL,NULL,NULL,15,4,'default',NULL,35,2,'',NULL,'default'),(17,'2023-08-07','15:00:00',NULL,NULL,NULL,NULL,15,5,'default',NULL,36,5,'Пугать',NULL,'default'),(18,'2023-08-07','16:30:00',NULL,NULL,NULL,NULL,15,7,'default',NULL,37,4,'',NULL,'default'),(19,'2023-08-10','15:00:00',NULL,NULL,NULL,NULL,15,4,'default',NULL,38,4,'Cool story',NULL,'default'),(20,'2023-08-12','15:00:00',NULL,NULL,NULL,NULL,15,5,'default',NULL,39,2,'',NULL,'default');
...
INSERT INTO `status_quest` VALUES (4,15),(5,15),(6,15),(7,15);
...
CREATE TABLE `statuses` (
  ...
  `status_type` enum('EMPTY','BLOCK','NEW_RESERVE','CONFIRMED','CANCEL','MODIFIED','USER','COMPLETED') NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `statuses` VALUES (4,'Отмена','CANCEL'),(5,'Блокировка','BLOCK'),(6,'Подтверждён','CONFIRMED'),(7,'Новый','NEW_RESERVE');
...
INSERT INTO `users` VALUES (22,'AdminTest','test',NULL,1);
...
-- Dump completed on 2023-08-12 16:09:36
